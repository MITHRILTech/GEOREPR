function [cHAC, cH, cAC] = eqHAC1(T, unit, cHAC0, cH0, cAC0, I)
...
K1 = 10 .^ (-6.634 + 0.01305*Tab + 1.236*I - 2.272*10^-5*Tab.^2 -...
    0.00388*Tab.*I + 2.866*I.^2+8.066*10^-12*Tab.^3 + 2.376*10^-5*Tab.^2.*I-0.0205*Tab.*I.^2);
% K2 = 10 .^ (-4.389 + 0.00229*Tab + 77.62./Tab);

aHF0 = cHAC0 .* gammaHF; aa = aHF0;
aH0 = cH0 .* gammaH; bb = aH0;
aF0 = cAC0 .* gammaF; cc = aF0;
